...
3. 在仓库 **Releases → Draft a new release** 创建版本，标签用 `v1.0.0`，标题用 `Translate Bridge for Zotero 1.0.0`，说明复制本目录 `RELEASE-1.0.0.md`。
4. 附加 `dist/translate-bridge-for-zotero-1.0.0.zip`。也可同时附加独立的 Chrome ZIP 与 Zotero XPI。
